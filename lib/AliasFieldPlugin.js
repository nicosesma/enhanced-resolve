...
class AliasFieldPlugin {
	...
	apply(resolver) {
		...
		resolver.plugin(this.source, (request, callback) => {
			...
			resolver.doResolve(target, obj, "aliased from description file " + request.descriptionFilePath + " with mapping '" + innerRequest + "' to '" + data + "'", createInnerCallback((err, result) => {
